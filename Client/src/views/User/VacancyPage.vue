...
<template>
  <GuestLayout>
    <div class="">
      ...
      <div class="relative flex flex-col gap-y-4 items-center justify-center overflow-hidden bg-gray-50 p-6 sm:py-12">
        <div
          ...
          <div>
            <button class="bg-light-blue text-white font-medium px-4 py-2 rounded-md flex gap-1 items-center">Apply Now
